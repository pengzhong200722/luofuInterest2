    ...
    treeGridColumns = [
      {
          ...
          formatter: function (value, row, index) {
              ...
              html = "<div class=\"grid-controls\"> <a href=\"javascript:void(0)\" class=\"easyui-menubutton\" data-options=\"menu:'#mm" + row.Id + "',iconCls:'icon-edit-down'\">编辑</a> <div id=\"mm" + row.Id + "\" style=\"width:100px;\"> <div onclick=\"" + modifyFuncHtml + "\" data-options=\"iconCls:'icon-edit'\">修改</div> <div onclick=\"" + removeFuncHtml + "\" data-options=\"iconCls:'icon-remove'\">删除</div> </div> </div>";
              return html;
          }
      }, {
          field: 'Id',
