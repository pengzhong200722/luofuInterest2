        ...
        [
          {
            ...
            formatter: function(value, row, index) {
              var html;
              html = "<div class=\"grid-controls\"><a href=\"javascript:void(0)\" class=\"easyui-menubutton\" data-options=\"menu:'#mm" + row.RoleId + "',iconCls:'ico-edit-down'\">编辑</a><div id=\"mm" + row.RoleId + "\" style=\"width:100px;\"><div onclick=\"modifyRole('" + row.RoleId + "');\" data-options=\"iconCls:'ico-edit'\">修改</div><div onclick=\"empowerRole('" + row.RoleId + "');\" data-options=\"iconCls:'ico-permission'\">授权</div><div onclick=\"removeRole('" + row.RoleId + "');\" data-options=\"iconCls:'ico-remove'\">删除</div></div></div>";
              return html;
            }
          }, {
            field: 'RoleName',
