    ...
    dataGridColumns=[
        {
            ...
            formatter: function (value, row, index) {
                var html;
                html = "<div class=\"grid-controls\"><a href=\"javascript:void(0)\" class=\"easyui-menubutton\"                                      data-options=\"menu:'#mm" + row.UserId + "',iconCls:'ico-edit-down'\">编辑</a>                                  <div id=\"mm" + row.UserId + "\" style=\"width:100px;\">                                      <div onclick=\"modifyUser('" + row.UserId + "');\" data-options=\"iconCls:'ico-edit'\">修改</div>                                    <div onclick=\"removeUser('" + row.UserId + "');\" data-options=\"iconCls:'ico-remove'\">删除</div>                                  </div>                              </div>";
                return html;
            }
        },
        {
